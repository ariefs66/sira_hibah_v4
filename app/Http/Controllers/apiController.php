...
class apiController extends Controller
{
	...
	public function apiSiraBL($tahun,$status, Request $req){
        ...
        $length = ($req->iDisplayLength == "")? 10000 : $req->iDisplayLength;
        $tabel = '';
        if($status=="murni"){
	...
	public function apiSiraBTL($tahun,$status, Request $req){
        ...
        if($status=="murni"){
            ...
            $tabel = '_PERUBAHAN';
            $data = BTLPerubahan::where('BTL_TAHUN',$tahun);
        }
        $view = array();
        if(strlen($kode)>0){
            $data = $data->JOIN('REFERENSI.REF_SUB_UNIT','DAT_BTL'.$tabel.'.SUB_ID','=','REF_SUB_UNIT.SUB_ID')
            ->JOIN('REFERENSI.REF_SKPD','REF_SKPD.SKPD_ID','=','REF_SUB_UNIT.SKPD_ID')
            ->JOIN('REFERENSI.REF_REKENING','REF_REKENING.REKENING_ID','=','DAT_BTL'.$tabel.'.REKENING_ID')
            ...
            ->groupBy("REF_URUSAN_KATEGORI1.URUSAN_KAT1_ID","REF_URUSAN_KATEGORI1.URUSAN_KAT1_KODE","REF_URUSAN_KATEGORI1.URUSAN_KAT1_NAMA","REF_URUSAN.URUSAN_ID","REF_URUSAN.URUSAN_KODE","REF_URUSAN.URUSAN_NAMA","REF_SUB_UNIT.SUB_ID","SUB_KODE","SUB_NAMA","REF_SKPD.SKPD_ID","REF_SKPD.SKPD_KODE","REF_SKPD.SKPD_NAMA","REF_REKENING.REKENING_ID","REF_REKENING.REKENING_KODE","REF_REKENING.REKENING_NAMA","BTL_NAMA")
            ->orderBy('URUSAN_KAT1_KODE','KEGIATAN_KODE')
            ->selectRaw('"REF_URUSAN_KATEGORI1"."URUSAN_KAT1_ID","URUSAN_KAT1_KODE","URUSAN_KAT1_NAMA","REF_URUSAN"."URUSAN_ID","URUSAN_KODE","URUSAN_NAMA","REF_SUB_UNIT"."SUB_ID","SUB_KODE","SUB_NAMA","REF_SKPD"."SKPD_ID","SKPD_KODE","SKPD_NAMA","REF_REKENING"."REKENING_ID","REKENING_KODE","REKENING_NAMA","BTL_NAMA",SUM("BTL_TOTAL") AS pagu');
        } else {
            $data = $data->JOIN('REFERENSI.REF_SUB_UNIT','DAT_BTL'.$tabel.'.SUB_ID','=','REF_SUB_UNIT.SUB_ID')
            ->JOIN('REFERENSI.REF_SKPD','REF_SKPD.SKPD_ID','=','REF_SUB_UNIT.SKPD_ID')
            ->JOIN('REFERENSI.REF_REKENING','REF_REKENING.REKENING_ID','=','DAT_BTL'.$tabel.'.REKENING_ID')
    ...
    public function apiSiraPembiayaan($tahun,$status, Request $req){
        ...
        $tabel = '';
        if($status=="murni"){
            $data = Pembiayaan::where('PEMBIAYAAN_TAHUN',$tahun);
        }else{
            $tabel = '_PERUBAHAN';
            $data = PembiayaanPerubahan::where('PEMBIAYAAN_TAHUN',$tahun);
        }
        $view           = array();
        if(strlen($kode)>0){
            $data = $data->JOIN('REFERENSI.REF_SKPD','REF_SKPD.SKPD_ID','=','DAT_PEMBIAYAAN'.$tabel.'.SKPD_ID')
            ->JOIN('REFERENSI.REF_REKENING','REF_REKENING.REKENING_ID','=','DAT_PEMBIAYAAN'.$tabel.'.REKENING_ID')
            ->JOIN('REFERENSI.REF_URUSAN_SKPD','REF_SKPD.SKPD_ID','=','REF_URUSAN_SKPD.SKPD_ID')
            ->JOIN('REFERENSI.REF_URUSAN','REF_URUSAN_SKPD.URUSAN_ID','=','REF_URUSAN.URUSAN_ID')
            ->JOIN('REFERENSI.REF_URUSAN_KATEGORI1','REF_URUSAN_KATEGORI1.URUSAN_KAT1_ID','=','REF_URUSAN.URUSAN_KAT1_ID')
            ->whereRaw("\"REKENING_KODE\" LIKE ?", [$kode])
    ...
    public function apiSiraPendapatan($tahun,$status, Request $req){
        ...
        if($status=="murni"){
            ...
            $tabel = '_PERUBAHAN';
            $data = PendapatanPerubahan::where('PENDAPATAN_TAHUN',$tahun);
        }
        $view           = array();
        if(strlen($kode)>0){
            ...
            ->JOIN('REFERENSI.REF_URUSAN_KATEGORI1','REF_URUSAN_KATEGORI1.URUSAN_KAT1_ID','=','REF_URUSAN.URUSAN_KAT1_ID')
            ->whereRaw("\"REKENING_KODE\" LIKE ?", [$kode])
            ->groupBy("REF_URUSAN_KATEGORI1.URUSAN_KAT1_ID","REF_URUSAN_KATEGORI1.URUSAN_KAT1_KODE","REF_URUSAN_KATEGORI1.URUSAN_KAT1_NAMA","REF_URUSAN.URUSAN_ID","REF_URUSAN.URUSAN_KODE","REF_URUSAN.URUSAN_NAMA","REF_SUB_UNIT.SUB_ID","SUB_KODE","SUB_NAMA","REF_SKPD.SKPD_ID","REF_SKPD.SKPD_KODE","REF_SKPD.SKPD_NAMA","REF_REKENING.REKENING_ID","REF_REKENING.REKENING_KODE","REF_REKENING.REKENING_NAMA","PENDAPATAN_NAMA")
            ->orderBy('URUSAN_KAT1_KODE','KEGIATAN_KODE')
            ->selectRaw('"REF_URUSAN_KATEGORI1"."URUSAN_KAT1_ID","URUSAN_KAT1_KODE","URUSAN_KAT1_NAMA","REF_URUSAN"."URUSAN_ID","URUSAN_KODE","URUSAN_NAMA","REF_SUB_UNIT"."SUB_ID","SUB_KODE","SUB_NAMA","REF_SKPD"."SKPD_ID","SKPD_KODE","SKPD_NAMA","REF_REKENING"."REKENING_ID","REKENING_KODE","REKENING_NAMA","PENDAPATAN_NAMA",SUM("PENDAPATAN_TOTAL") AS pagu');
        } else {
            $data = Pendapatan::JOIN('REFERENSI.REF_SUB_UNIT','DAT_PENDAPATAN.SUB_ID','=','REF_SUB_UNIT.SUB_ID')
            ->JOIN('REFERENSI.REF_SKPD','REF_SKPD.SKPD_ID','=','REF_SUB_UNIT.SKPD_ID')
            ->JOIN('REFERENSI.REF_REKENING','REF_REKENING.REKENING_ID','=','DAT_PENDAPATAN.REKENING_ID')
