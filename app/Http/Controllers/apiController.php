...
class apiController extends Controller
{
	...
	public function apiSiraBL($tahun,$status, Request $req){
        ...
        if(strlen($kode)>0){
            ...
            ->groupBy("REF_URUSAN_KATEGORI1.URUSAN_KAT1_ID",
                "REF_URUSAN_KATEGORI1.URUSAN_KAT1_KODE","REF_URUSAN_KATEGORI1.URUSAN_KAT1_NAMA",
                "REF_URUSAN.URUSAN_ID","REF_URUSAN.URUSAN_KODE","REF_URUSAN.URUSAN_NAMA",
                "REF_SKPD.SKPD_ID","REF_SKPD.SKPD_KODE","REF_SKPD.SKPD_NAMA",
                "REF_SUB_UNIT.SUB_ID","REF_SUB_UNIT.SUB_KODE","REF_SUB_UNIT.SUB_NAMA",
                "REF_PROGRAM.PROGRAM_ID","REF_PROGRAM.PROGRAM_NAMA","REF_KEGIATAN.KEGIATAN_ID",
                "REF_KEGIATAN.KEGIATAN_KODE","REF_KEGIATAN.KEGIATAN_NAMA",
                "DAT_RINCIAN.RINCIAN_ID","REF_REKENING.REKENING_ID",
                "REF_REKENING.REKENING_KODE","REF_REKENING.REKENING_NAMA")
            ->orderBy('URUSAN_KAT1_KODE','KEGIATAN_KODE')
            ->selectRaw('"REF_URUSAN_KATEGORI1"."URUSAN_KAT1_ID","URUSAN_KAT1_KODE","URUSAN_KAT1_NAMA","REF_URUSAN"."URUSAN_ID","URUSAN_KODE","URUSAN_NAMA","REF_SKPD"."SKPD_ID","SKPD_KODE","SKPD_NAMA","REF_SUB_UNIT.SUB_ID","SUB_KODE","SUB_NAMA","REF_PROGRAM"."PROGRAM_ID","PROGRAM_KODE","PROGRAM_NAMA","REF_KEGIATAN"."KEGIATAN_ID","KEGIATAN_KODE","KEGIATAN_NAMA","REF_REKENING"."REKENING_ID","REKENING_KODE","REKENING_NAMA",SUM("RINCIAN_TOTAL") AS pagu');
        } else {
            $data = BL::JOIN('REFERENSI.REF_SUB_UNIT','DAT_BL.SUB_ID','=','REF_SUB_UNIT.SUB_ID')
            ->JOIN('REFERENSI.REF_SKPD','REF_SKPD.SKPD_ID','=','REF_SUB_UNIT.SKPD_ID')
            ->JOIN('REFERENSI.REF_KEGIATAN','REF_KEGIATAN.KEGIATAN_ID','=','DAT_BL.KEGIATAN_ID')
            ...
            ->groupBy("REF_URUSAN_KATEGORI1.URUSAN_KAT1_ID",
                ...
                "REF_PROGRAM.PROGRAM_ID","REF_PROGRAM.PROGRAM_NAMA","REF_KEGIATAN.KEGIATAN_ID",
                "REF_KEGIATAN.KEGIATAN_KODE","REF_KEGIATAN.KEGIATAN_NAMA",
                "DAT_RINCIAN.RINCIAN_ID","REF_REKENING.REKENING_ID","REF_REKENING.REKENING_KODE","REF_REKENING.REKENING_NAMA")
            ->orderBy('URUSAN_KAT1_KODE','KEGIATAN_KODE')
            ->selectRaw('"REF_URUSAN_KATEGORI1"."URUSAN_KAT1_ID","URUSAN_KAT1_KODE","URUSAN_KAT1_NAMA","REF_URUSAN"."URUSAN_ID","URUSAN_KODE","URUSAN_NAMA","REF_SKPD"."SKPD_ID","SKPD_KODE","SKPD_NAMA","REF_SUB_UNIT.SUB_ID","SUB_KODE","SUB_NAMA","REF_PROGRAM"."PROGRAM_ID","PROGRAM_KODE","PROGRAM_NAMA","REF_KEGIATAN"."KEGIATAN_ID","KEGIATAN_KODE","KEGIATAN_NAMA","REF_REKENING"."REKENING_ID","REKENING_KODE","REKENING_NAMA",SUM("RINCIAN_TOTAL") AS pagu');
        }
