      ...
      <div class="app-content-body ">
          ...
          <div class="bg-light lter">    
              <ul class="breadcrumb bg-white m-b-none">
                ...
                <li class="active"><i class="fa fa-angle-right"></i>Fungsi Urusan</li>                                
              </ul>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel bg-white">
                  <div class="wrapper-lg">
                    ...
                    <button class="pull-right btn m-t-n-sm btn-success open-form-btl"><i class="m-r-xs fa fa-plus"></i> Tambah Fungsi</button>   
                    @endif
                    <h5 class="inline font-semibold text-orange m-n ">Fungsi Urusan Tahun {{ $tahun }}</h5>
                        ...
                        <div role="tabpanel" class="active tab-pane" id="tab-1">  
                            <div class="table-responsive dataTables_wrapper">
                             <table ui-jq="dataTable" ui-options="{
                                    sAjaxSource: '{{ url('/') }}/main/{{$tahun}}/{{$status}}/pengaturan/fungsi/getData',
                                    aoColumns: [
