      ...
      <div class="app-content-body ">
          ...
          <div class="bg-light lter">    
              <ul class="breadcrumb bg-white m-b-none">
                ...
                <li class="active"><i class="fa fa-angle-right"></i>Bidang</li>                                
              </ul>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel bg-white">
                  <div class="wrapper-lg">
                    ...
                    <button class="pull-right btn m-t-n-sm btn-success open-form-btl"><i class="m-r-xs fa fa-plus"></i> Tambah Bidang</button>   
                    @endif
                    <h5 class="inline font-semibold text-orange m-n ">Bidang Tahun {{ $tahun }}</h5>
                        ...
                        <div role="tabpanel" class="active tab-pane" id="tab-1">  
                            <div class="table-responsive dataTables_wrapper">
                             <table ui-jq="dataTable" ui-options="{
                                    sAjaxSource: '{{ url('/') }}/main/{{$tahun}}/{{$status}}/pengaturan/bidang/getData',
                                    aoColumns: [
                                    ...
                                    <thead>
                                      ...
                                      <tr>
                                        <th colspan="5" class="th_search">
                                            ...
                                            <input type="search" class="table-search form-control b-none w-full" placeholder="Cari Bidang" aria-controls="DataTables_Table_0">
                                        </th>
                                      </tr>
                                    </thead>
                                    <tbody>
