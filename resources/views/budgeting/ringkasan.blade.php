                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            <th width="1%">Kode</th>
                            <th>Uraian</th>
                            <th width="20%" class="text-right">Murni</th>
                            <th width="20%" class="text-right">Pergeseran</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="text-right"><b> {{ number_format($blvp+($btl1p+$btl3p+$btl4p+$btl7p+$btl8p),0,',','.') }}</b></td>
                          </tr>                              
                          <tr>
                            <td><b>2.1</b></td>
                            <td><b>BELANJA TIDAK LANGSUNG</b></td>
                            <td class="text-right"><b> {{ number_format($btl1+$btl3+$btl4+$btl7+$btl8,0,',','.') }}</b></td>
                            <td class="text-right"><b> {{ number_format($btl1p+$btl3p+$btl4p+$btl7p+$btl8p,0,',','.') }}</b></td>
                          </tr>    
                          <tr>
                            <td>2.1.1</td>
                            <td>Belanja Pegawai</td>
                            <td class="text-right"> {{ number_format($btl1,0,',','.') }}</td>
                            <td class="text-right"> {{ number_format($btl1p,0,',','.') }}</td>
                          </tr>                                                        
                          <tr>
                            <td>2.1.3</td>
                            <td>Belanja Subsidi</td>
                            <td class="text-right"> {{ number_format($btl3,0,',','.') }}</td>
                            <td class="text-right"> {{ number_format($btl3p,0,',','.') }}</td>
                          </tr>                                                        
                          <tr>
                            <td>2.1.4</td>
                            <td>Belanja Hibah</td>
                            <td class="text-right"> {{ number_format($btl4,0,',','.') }}</td>
                            <td class="text-right"> {{ number_format($btl4p,0,',','.') }}</td>
                          </tr>                                                        
                          <tr>
                            <td>2.1.7</td>
                          ...
                          <tr>
                            ...
                            <td class="text-right"><b> ({{ number_format(($blvp+$btl1p+$btl3p+$btl4p+$btl7p+$btl8p)-$pdp,0,',','.') }})</b></td>
                          </tr>   
                          <tr>
                            <td><b>3</b></td>
                            <td><b>PEMBIAYAAN DAERAH</b></td>
                            <td class="text-right"><b> {{ number_format($penerimaan-$pengeluaran,0,',','.') }}</b></td>
                            <td class="text-right"><b> {{ number_format($penerimaanp-$pengeluaranp,0,',','.') }}</b></td>
                          </tr>                                                                                     
                          <tr>
                            <td><b>3.1</b></td>
                            <td><b>PENERIMAAN PEMBIAYAAN DAERAH</b></td>
                            <td class="text-right"><b> {{ number_format($penerimaan,0,',','.') }}</b></td>
                            <td class="text-right"><b> {{ number_format($penerimaanp,0,',','.') }}</b></td>
                          </tr>   
                          ...
                          <tr>
                            ...
                            <td class="text-right"><b> {{ number_format($pengeluaranp,0,',','.') }}</b></td>
                          </tr>   
                          ...
                          <tr>
                            ...
                            ,0,',','.') }}) </b></td>
                            @endif
                            @if(($blvp+$btl1p+$btl3p+$btl4p+$btl7p+$btl8p+$pengeluaranp)-$pdp-$penerimaanp < 0)
                            <td class="text-right"><b> {{ number_format($pdp+$penerimaanp-($blvp+$btl1p+$btl3p+$btl4p+$btl7p+$btl8p+$pengeluaranp),0,',','.') }} </b></td>
                            @else
                            <td class="text-right"><b> ({{ number_format(
                            ($blvp+$btl1p+$btl3p+$btl4p+$btl7p+$btl8p+$pengeluaranp)-$pdp-$penerimaanp
                            ,0,',','.') }}) </b></td>
                            @endif 
                          </tr>  
                        </tbody>
