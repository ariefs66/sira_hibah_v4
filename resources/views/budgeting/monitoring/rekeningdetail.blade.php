      ...
      <div class="app-content-body ">
        ...
        <div class="bg-light lter">    
          <ul class="breadcrumb bg-white m-b-none">
            ...
            <li><i class="fa fa-angle-right"></i>Rekening</li>                                
            <li class="active"><i class="fa fa-angle-right"></i>{{$rekening->REKENING_NAMA}}</li>                                
          </ul>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel bg-white">
                <div class="wrapper-lg">
                  <h5 class="inline font-semibold text-orange m-n ">Daftar Kegiatan Rekening {{$rekening->REKENING_KODE}} - {{$rekening->REKENING_NAMA}}</h5>
               ...
               <div class="tab-content tab-content-alt-1 bg-white">
                <div role="tabpanel" class="active tab-pane" id="tab-1">  
                  <div class="table-responsive dataTables_wrapper table-statistik">
                   ...
                   sAjaxSource: '{{ url('/') }}/main/{{$tahun}}/{{$status}}/statistik/rekening/api/{{$rekening->REKENING_ID}}',
                   aoColumns: [
                   { mData: 'ID',class:'hide'},
                   { mData: 'NO'},
                   { mData: 'NAMA'},
