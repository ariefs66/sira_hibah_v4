      ...
      <div class="app-content-body ">
        ...
        <div class="bg-light lter">    
          <ul class="breadcrumb bg-white m-b-none">
            ...
            <li class="active"><i class="fa fa-angle-right"></i>Paket</li>                                
          </ul>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel bg-white">
                <div class="wrapper-lg">
                  <h5 class="inline font-semibold text-orange m-n ">Daftar Paket / Subrincian Tahun {{$tahun}}</h5>
               ...
               <div class="tab-content tab-content-alt-1 bg-white">
                <div role="tabpanel" class="active tab-pane" id="tab-1">  
                  <div class="table-responsive dataTables_wrapper table-statistik">
                   ...
                   sAjaxSource: '{{ url('/') }}/main/{{$tahun}}/{{$status}}/statistik/paket/api',
                   aoColumns: [
                   { mData: 'ID',class:'hide'},
                   { mData: 'NO'},
                   { mData: 'NAMA'},
                   ...
                   <thead>
                    <tr>
                      ...
                      <th class="text-center">Nama Paket / Subrincian</th>
...
<script type="text/javascript">
  ...
  $('#table-statistik').on('click','tbody > tr', function(){
      ...
      window.open("{{ url('/') }}/main/{{$tahun}}/{{$status}}/statistik/paket/detail/"+kode);
   })
</script>
@endsection