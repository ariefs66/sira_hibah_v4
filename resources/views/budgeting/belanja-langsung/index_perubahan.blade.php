  ...
  <div class="modal-dialog bg-white">
    <div class="panel panel-default">
      <div class="wrapper-lg">
        ...
        <p class="m-t-n-sm">Latar Belakang</p>
        <textarea class="form-control m-t-sm" placeholder="Latar Belakang" id="urgensi_latar_belakang"></textarea>
        ...
        <textarea class="form-control m-t-sm" placeholder="Dimanakah Lokasi dari Kegiatan Ini" id="urgensi_lokasi"></textarea>
        ...
        <select class="form-control m-t-sm col-md-6" id="urgensi_penerima_rincian">
          <option value="-">---</option>
        </select>
        </div>
...
function setStaff(){
  ...
  function simpanpagu(){
    ...
    @if(Auth::user()->level == 2)
    if(catatan == "" || surat == "" || usulan == "") $.alert('Masukan Alasan dan Nomor Surat!');
    else{
      $.ajax({
