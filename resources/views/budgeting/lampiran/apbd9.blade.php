...
<div class="cetak">
	...
	<h5>LAMPIRAN IX &nbsp; &nbsp; &nbsp; Rancangan Peraturan Daerah</h5>
	<h5>NOMOR : </h5>
	<h5>TANGGAL :</h5>
	</div>
	<br>
<table class="header">
	<tr class="border">
		<td class="border">
			...
			<h3>DAFTAR PERKIRAAN PENAMBAHAN DAN PENGURANGAN ASET TETAP DAERAH</h3>
...
<table class="rincian">
	...
	<tr>
		...
		<td class="border-rincian kiri total">Tanah</td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
	...
	<tr>
		...
		<td class="border-rincian kiri total">Peralatan & Mesin</td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
	...
	<tr>
		<td class="border-rincian kanan total">3</td>
		<td class="border-rincian kiri total">Gedung dan Bangunan</td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
	...
	<tr>
		<td class="border-rincian kanan total">4</td>
		<td class="border-rincian kiri total">Jalan, Irigasi dan Jaringan</td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
		<td class="border-rincian kanan total"></td>
