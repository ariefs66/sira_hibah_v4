...
<table class="rincian">
	...
	<tr>
		...
		@if ($totP2s<0)
		<td class="border-rincian kanan">({{ number_format(abs($totP2s),0,',','.') }})</td>
		@else
		<td class="border-rincian kanan">{{ number_format($totP2s,0,',','.') }}</td>
		@endif
		<td class="border-rincian kanan"></td>
	</tr>	
	...
	<td class="border-rincian">4.1.1.03</td>
		...
		@if ($totP3s<0)
		<td class="border-rincian kanan">({{ number_format(abs($totP3s),0,',','.') }})</td>
		@else
		<td class="border-rincian kanan">{{ number_format($totP3s,0,',','.') }}</td>
		@endif
		<td class="border-rincian kanan"></td>
	</tr>	
	...
	<tr>
		...
		@if ($totP4s<0)
		<td class="border-rincian kanan">({{ number_format(abs($totP4s),0,',','.') }})</td>
		@else
		<td class="border-rincian kanan">{{ number_format($totP4s,0,',','.') }}</td>
		@endif
		<td class="border-rincian kanan"></td>
	</tr>	
...
@php $totP5=0 @endphp	
	...
	<td class="border-rincian">4.1.1.05</td>
		...
		@if ($totP5s<0)
		<td class="border-rincian kanan">({{ number_format(abs($totP5s),0,',','.') }})</td>
		@else
		<td class="border-rincian kanan">{{ number_format($totP5s,0,',','.') }}</td>
		@endif
		<td class="border-rincian kanan"></td>
	</tr>	
	@php $pendapatan3_totalp = array(count($pendapatan3p)); $i=0; @endphp
	...
	<!-- pajak retribusi -->
	<tr>
		<td class="border-rincian"><b>4.1.2</b></td>
		<td class="border-rincian"><b>&nbsp; &nbsp;Retribusi Daerah</b></td>
		<td class="border-rincian kanan total">{{ number_format($totpad2,0,',','.') }}</td>
		<td class="border-rincian kanan"></td>
	</tr>
	@php $totP10=0; @endphp	
	...
	<tr>
		<td class="border-rincian"><b>4.1.3</b></td>
	...
	<tr>
		<td class="border-rincian"><b>4.1.4</b></td>
	...
	<tr>
		<td class="border-rincian"><b>4.2</b></td>
	...
	<tr>
		<td class="border-rincian"><b>4.2.1</b></td>
	...
	@endforeach	
	<tr>
		<td class="border-rincian"><b>4.2.2</b></td>
	...
	<tr>
		...
		<tr>
			...
			<td class="border-rincian kanan garis">{{ number_format($totP22,0,',','.') }}</td>
			<td class="border-rincian kanan"></td>
		</tr>	
		@foreach($pendapatan22 as $pen)
		<tr>
