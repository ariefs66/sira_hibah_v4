...
<table class="rincian">
	...
	<tr>
	  ...
	  @else
	  <td class="border-rincian kanan">{{ number_format($k->komponen->KOMPONEN_HARGA,0,',','.') }},00</td>
	  <td class="border-rincian kanan">{{ number_format($p->RINCIAN_PAJAK,0,',','.') }}</td>
	  @endif
	  @if($k->RINCIAN_PAJAK == 0)
	  <td class="border-rincian kanan">0,00</td>
	  @else
	  <td class="border-rincian kanan" colspan="2">{{ number_format($k->RINCIAN_HARGA/10,0,',','.') }},00 </td>
	  @endif
