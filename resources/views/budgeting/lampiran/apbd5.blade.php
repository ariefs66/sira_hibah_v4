...
<div class="cetak">
	...
	<h5 style="margin-right: -500px;">NOMOR &nbsp; &nbsp; : {{(isset($nomor_ttd) ? (strlen($nomor_ttd)>0?$nomor_ttd:'12 Tahun 2017') : '12 Tahun 2017')}}</h5>
	<h5 style="margin-right: -520px;">TANGGAL &nbsp;: {{(isset($tgl_ttd) ? (strlen($tgl_ttd)>0?$tgl_ttd:$tgl.' '.$bln.' '.$thn) : '29 Desember 2017')}}</h5>
	</div>
	<br>
<table class="header">	
	<tr class="">
