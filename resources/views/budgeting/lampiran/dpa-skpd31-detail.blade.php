...
<table class="rincian">
	...
	<tr class="border">
		<td class="border kiri" colspan="3"> &nbsp; &nbsp; &nbsp; <b> Rencana Penerimaan Per Triwulan </b></td>
	</tr>
	</tbody>	
</table>
<table class="ttd">
	...
	<tr>
		...
		{{(isset($nama_ttd) ? (strlen($nama_ttd)>0?$nama_ttd:'Drs. DADANG SUPRIATNA, MH') : 'Drs. DADANG SUPRIATNA, MH')}} <br>
