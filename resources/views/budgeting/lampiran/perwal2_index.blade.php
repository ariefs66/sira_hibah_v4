            ...
            <div class="row">
              <div class="col-md-12">
                <div class="panel bg-white">
                  <div class="wrapper-lg">
                    <h5 class="inline font-semibold text-orange m-n ">{{$tipe}} 2 - {{ $tahun }}</h5>
                            ...
                            <div class="table-responsive dataTables_wrapper">
                             <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        {{ $s->SKPD_NAMA }}
                                        <a href="{{ url('/') }}/main/{{ $tahun }}/{{ $status }}/lampiran/apbd/perwal/2/{{ $s->SKPD_ID }}" class="btn btn-success pull-right m-t-n-sm m-r-xs" target="_blank"><i class="fa fa-print"></i> Cetak Perwal 2 </a>
                                      </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
