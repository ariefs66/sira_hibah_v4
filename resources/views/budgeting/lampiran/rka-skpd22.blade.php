                            ...
                            <div class="table-responsive dataTables_wrapper">
                             <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        {{ $s->SKPD_NAMA }}
                                        <a href="{{ url('/') }}/main/{{ $tahun }}/{{ $status }}/lampiran/rka/skpd22/{{ $s->SKPD_ID }}" class="btn btn-success pull-right m-t-n-sm m-r-xs" target="_blank"><i class="fa fa-print"></i> RKA-SKPD 2.2 </a>
                                      </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
