...
<div class="cetak">
	...
	<h5 style="margin-right: -495px;">NOMOR &nbsp; &nbsp; : {{(isset($nomor_ttd) ? (strlen($nomor_ttd)>0?$nomor_ttd:'') : '12 Tahun 2017')}}</h5>
	<h5 style="margin-right: -517px;">TANGGAL &nbsp;: {{(isset($tgl_ttd) ? (strlen($tgl_ttd)>0?$tgl_ttd:$tgl.' '.$bln.' '.$thn) : '29 Desember 2017')}} </h5>
	</div>
	<br>
<table class="header">
	<tr class="">
...
<table class="rincian">
	...
	<tr>
		...
		</td><td class="border-rincian kanan total">
	...
	<tr>
		...
		@endif
		</b></td><td class="border kanan total"><b>
		@php $surdef = $pendapatan-$totbelanja  @endphp	
		@if($surdef<0)
		({{ trim(number_format((float)$surdef, 2, ',', '.'),"-") }})
		@else
...
<table class="ttd">
	...
	<tr>
		<td></td>
		<td><b>{{(isset($jabatan_ttd) ? (strlen($jabatan_ttd)>0?$jabatan_ttd:'WALI KOTA BANDUNG') : 'WALI KOTA BANDUNG')}}</b></td>
	</tr>
	<tr>
		<td></td>
