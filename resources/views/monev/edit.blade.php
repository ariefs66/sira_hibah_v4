    ...
    <div class="input-wrapper">
      ...
      <div class="form-group" id="dupe">
        ...
        <div class="col-sm-4">
          ...
          <input type="hidden" class="form-control" id="satuan" placeholder="Satuan" ></input>
          <input type="text" class="form-control" id="output_target" placeholder="Output Target" ></input>
          <input type="hidden" class="form-control" id="output" placeholder="Output Satuan" ></input>
        </div>
      </div>
